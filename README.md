...
[![Website](https://img.shields.io/badge/Website-project%20page-0A84FF?logo=githubpages&logoColor=white)](https://elias0505.github.io/ha-companion-windows/)
...
- **Tile quick controls** — right-click a tile: brightness slider, **colour swatches and colour temperature** for capable lights (detected from `supported_color_modes`), target temperature for climate, and a full transport row (⏮ ▶⏸ ⏭ + volume) for media players. Media tiles also carry an **inline play/pause button**, show the current track, and light up while playing.
